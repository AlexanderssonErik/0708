...
let numbers = {
 ...
 // meshLink: [],
  init: function(scene){
   ...
   /* this.meshLink[0] = "numbers/0.jpg";
    this.meshLink[1] = "numbers/1.jpg";
    this.meshLink[2] = "numbers/2.jpg";
    this.meshLink[3] = "numbers/3.jpg";
    this.meshLink[4] = "numbers/4.jpg";
    this.meshLink[5] = "numbers/5.jpg";
    this.meshLink[6] = "numbers/6.jpg";
    this.meshLink[7] = "numbers/7.jpg";
    this.meshLink[8] = "numbers/8.jpg";
    this.meshLink[9] = "numbers/9.jpg";

    this.meshLink[10] = "numbers/forth.jpg";
    this.meshLink[11] = "numbers/half.jpg";
    this.meshLink[12] = "numbers/third.jpg";
    //wrong?

    this.meshLink[13] = "numbers/less.jpg";
    this.meshLink[14] = "numbers/greater.jpg";
    this.meshLink[15] = "numbers/equal.jpg";
    this.meshLink[16] = "numbers/plus.jpg";
    this.meshLink[17] = "numbers/minus.jpg";*/
   ...
   // BABYLON.SceneLoader.ImportMesh("", "", "zero.jpg", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 0);}.bind(this));
  ...
  loadInMeshes(){
    ...
    /*for(let i = 0; i < 18; i++){
      BABYLON.SceneLoader.ImportMesh("", "", this.meshLink[i], this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, i);}.bind(this));
      console.log("call");
    }*/
 ...
 /*
BABYLON.SceneLoader.ImportMesh("", "", "numbers/0.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 0);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/1.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 1);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/2.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 2);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/3.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 3);}.bind(this));
//3 is empty
BABYLON.SceneLoader.ImportMesh("", "", "numbers/4.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 4);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/5.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 5);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/6.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 6);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/7.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 7);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/8.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 8);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/9.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 9);}.bind(this));

BABYLON.SceneLoader.ImportMesh("", "", "numbers/forth.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 10);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/half.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 11);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/third.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 12);}.bind(this));


BABYLON.SceneLoader.ImportMesh("", "", "numbers/less.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 13);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/greater.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 14);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/equal.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 15);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/plus.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 16);}.bind(this));
BABYLON.SceneLoader.ImportMesh("", "", "numbers/minus.babylon", this.scene, function(newMeshes, particleSystems, skeletons) {this.initMesh(newMeshes, particleSystems, skeletons, 17);}.bind(this));
*/
...
this.loading = false;
  ...
  showNumber(val, color){
    ...
    //console.log("this.symbolMeshes[0].x: " + this.meshes[0]);
/*
    if(this.myMeshRight != null){
      this.myMeshRight.dispose();  
    }
